...
assert.match(app, /const optionalRouteStylesheetVersion = "play-human-matchmaking-v235";/, "The human matchmaking entry must request its current route stylesheet rather than a released-board cache key.");
...
assert.match(html, /assets\/app\.js\?v=play-human-matchmaking-v235/, "The shipped shell must request the current human matchmaking controller.");
assert.match(serviceWorker, /nschess-shell-v185-human-matchmaking[\s\S]*?assets\/app\.js\?v=play-human-matchmaking-v235/, "The offline shell must refresh with the human matchmaking controller.");
